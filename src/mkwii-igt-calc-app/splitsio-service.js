...
export class SplitsIOService {
	...
	updateSegmentEndTimes() {
		let sum = 0;
		this.splits.forEach((element, index) => {
     ...
     * @return {Object} Exchange JSON object
     */
     ...
     * @return {Promise<Response>} A promise that resolves a Response object
     */
     ...
     * @return {Object<String, String>} URI for the run with its claim token
     */
